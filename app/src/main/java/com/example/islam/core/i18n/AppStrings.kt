...
data class AppStrings(
    ...
    val streakCardDescription: String,
    val streakWeekLabels: List<String>, // Mon..Sun (7)
    val streakWeeklyProgress: String,
    val greetingGeneric: String,
    val greetingWithNameFormat: String,
    val streakCongratsWithNameFormat: String,
    ...
    val namePromptTitle: String,
    val namePromptDescription: String,
    val nameInputLabel: String,
    ...
    // Kişiselleştirme
    val nameEditTitle: String,
    val personalizedAddressingTitle: String,
    val personalizedAddressingDesc: String,
    val personalizedNotificationsTitle: String,
    val personalizedNotificationsDesc: String,
...
val TurkishStrings = AppStrings(
    ...
    streakCardDescription = "Her gün namazlarını takip et\nibadet düzenini güçlendir",
    streakWeekLabels = listOf("Pt", "Sa", "Ça", "Pe", "Cu", "Ct", "Pz"),
    streakWeeklyProgress = "Haftalık İlerleme",
    greetingGeneric = "Assalamu Aleykum",
    greetingWithNameFormat = "Assalamu Aleykum, %s",
    streakCongratsWithNameFormat = "Maşallah %s, bugün hedef tamamlandı.",
    ...
    namePromptTitle = "Adın (Opsiyonel)",
    namePromptDescription = "İstersen adını ekle, sana daha kişisel hitap edelim.",
    nameInputLabel = "Adın",
    nameInputPlaceholder = "Örn: Baran",
    nameSave = "Kaydet",
    nameSkip = "Atla",
    next          = "İleri",
    grantAndStart = "İzin Ver ve Başla",
    skipForNow    = "Şimdilik Geç",
    nameEditTitle = "Kişiselleştirme",
    personalizedAddressingTitle = "Kişisel hitap",
    personalizedAddressingDesc = "Ana ekranda selamlama ve tebrik metinlerinde adını gösterir.",
    personalizedNotificationsTitle = "İsimli bildirimler",
    personalizedNotificationsDesc = "Bildirimlerde adınla hitap kullanılmasını sağlar.",
...
val EnglishStrings = AppStrings(
    ...
    streakCardDescription = "Track your daily prayers\nand strengthen your worship routine",
    streakWeekLabels = listOf("M", "Tu", "W", "Th", "F", "Sa", "Su"),
    streakWeeklyProgress = "Weekly Progress",
    greetingGeneric = "Assalamu Alaikum",
    greetingWithNameFormat = "Assalamu Alaikum, %s",
    streakCongratsWithNameFormat = "MashaAllah %s, today's goal is complete.",
    ...
    namePromptTitle = "Your Name (Optional)",
    namePromptDescription = "Add your name if you want a more personal experience.",
    nameInputLabel = "Name",
    nameInputPlaceholder = "e.g. Ahmad",
    nameSave = "Save",
    nameSkip = "Skip",
    next          = "Next",
    grantAndStart = "Grant & Start",
    skipForNow    = "Skip for now",
    nameEditTitle = "Personalization",
    personalizedAddressingTitle = "Personal addressing",
    personalizedAddressingDesc = "Shows your name in home greetings and congrats messages.",
    personalizedNotificationsTitle = "Named notifications",
    personalizedNotificationsDesc = "Allows notifications to address you by name.",
...
val ArabicStrings = AppStrings(
    ...
    streakCardTitle = "سلسلة",
    streakCardDescription = "تابع صلواتك كل يوم\nوعزّز انتظام عبادتك",
    streakWeekLabels = listOf("إث", "ثل", "أر", "خم", "جم", "سب", "أح"),
    streakWeeklyProgress = "التقدم الأسبوعي",
    greetingGeneric = "السلام عليكم",
    greetingWithNameFormat = "السلام عليكم، %s",
    streakCongratsWithNameFormat = "ما شاء الله %s، تم إنجاز هدف اليوم.",
    ...
    namePromptTitle = "اسمك (اختياري)",
    namePromptDescription = "أضف اسمك إذا رغبت في تجربة أكثر خصوصية.",
    nameInputLabel = "الاسم",
    nameInputPlaceholder = "مثال: أحمد",
    nameSave = "حفظ",
    nameSkip = "تخطي",
    next          = "التالي",
    grantAndStart = "منح الإذن والبدء",
    skipForNow    = "تخطي الآن",
    nameEditTitle = "التخصيص",
    personalizedAddressingTitle = "المخاطبة الشخصية",
    personalizedAddressingDesc = "يُظهر اسمك في التحية ورسائل التهنئة في الصفحة الرئيسية.",
    personalizedNotificationsTitle = "إشعارات باسمك",
    personalizedNotificationsDesc = "يسمح بعرض اسمك داخل نص الإشعارات.",
